...
class RelatedUserRelationTest < ActiveSupport::TestCase
  ...
  test 'search' do
    ...
    assert_equal related_user_relations(:bare_first_time_relation).user_id,
      @related_user_relation.user_id
    assert_equal related_user_relations(:bare_first_time_relation).related_user_id,
  ...
  test 'update' do
    ...
    assert_equal users(:manager).id, @related_user_relation.related_user_id
  end
  ...
  test 'validates unique attributes' do
    related_user_relation = RelatedUserRelation.find(
      related_user_relations(:general_manager_coordinator_manager_relation).id
    )
