...
class FindingTest < ActiveSupport::TestCase
  ...
  test 'validates special blank attributes' do
    ...
    @finding = Finding.find(findings(:incomplete_weakness).id)
  ...
  test 'validates special not blank attributes' do
    finding = Finding.find(findings(:unanswered_weakness).id)
  ...
  test 'validates duplicated attributes' do
    another_finding = Finding.find(findings(:being_implemented_weakness).id)
    ...
    another_finding = Finding.find(findings(:unconfirmed_for_notification_weakness).id)
    @finding.review_code = another_finding.review_code
  ...
  test 'validates exceptional status change' do
    finding = Finding.find(
      findings(:being_implemented_weakness_on_final).id
    )
  ...
  test 'validates implemented audited with work papers' do
    finding = Finding.find(findings(:being_implemented_weakness_on_final).id)
  ...
  test 'status change from confirmed must have an answer' do
    finding = Finding.find(findings(:confirmed_oportunity).id)
  ...
  test 'mark as duplicated' do
    ...
    repeated_of = Finding.find(findings(:being_implemented_weakness_on_final).id)
  ...
  test 'work papers can be added to uneditable findings' do
    uneditable_finding = Finding.find(findings(:being_implemented_weakness).id)
  ...
  test 'work papers can not be added to uneditable and closed control objectives' do
    uneditable_finding = Finding.find(findings(:being_implemented_weakness_on_final).id)
