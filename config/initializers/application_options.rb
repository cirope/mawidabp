ALLOW_CONCLUSION_FINAL_REVIEW_DESTRUCTION_DAYS = ENV['ALLOW_CONCLUSION_FINAL_REVIEW_DESTRUCTION_DAYS']&.to_i || 0
...
CHECK_FINDING_EMAIL_REPLIES = ENV['EMAIL_SERVER'].present?
CONCLUSION_REVIEW_FEATURE_DATES = JSON.parse ENV['CONCLUSION_REVIEW_FEATURE_DATES'].presence || '{}'
...
ENABLE_USER_CREATION_WHEN_LDAP = ENV['ENABLE_USER_CREATION_WHEN_LDAP'] == 'true'
ENABLE_PUBLIC_REGISTRATION = ENV['ENABLE_PUBLIC_REGISTRATION'] == 'true'
EXTRA_USERS_INFO = JSON.parse ENV['EXTRA_USERS_INFO'].presence || '{}'
...
FINDING_REPEATABILITY_FILE = JSON.parse ENV['FINDING_REPEATABILITY_FILE'].presence || '{}'
FINDING_RISK_TYPES = JSON.parse ENV['FINDING_RISK_TYPES'].presence || '{}'
...
ORGANIZATIONS_WITH_INTERNAL_CONTROL_QUALIFICATION_REPORT = JSON[ENV['ORGANIZATIONS_WITH_INTERNAL_CONTROL_QUALIFICATION_REPORT']] || []
PLAN_ITEM_REVIEW_CONCLUDED_ON = ENV['PLAN_ITEM_REVIEW_CONCLUDED_ON'] || 'created_at'
REQUIRED_BY_OPTIONS_MEMO = JSON[ENV['REQUIRED_BY_OPTIONS_MEMO']] || []
RISK_WEIGHTS = JSON.parse ENV['RISK_WEIGHTS'].presence || '{}'
SCORE_BY_WEAKNESS = JSON.parse ENV['SCORE_BY_WEAKNESS'].presence || '{}'
...
SHOW_MEMOS = ENV['SHOW_MEMOS'] == 'true' || false
...
USE_GLOBAL_WEAKNESS_REVIEW_CODE = String(ENV['USE_GLOBAL_WEAKNESS_REVIEW_CODE']).split
...
WEAKNESS_TAG_COUNT_BY_ORGANIZATION = JSON.parse ENV['WEAKNESS_TAG_COUNT_BY_ORGANIZATION'].presence || '{}'
