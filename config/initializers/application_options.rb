...
ORGANIZATIONS_WITH_PROCESS_CONTROL_COMMENTS = String(ENV['ORGANIZATIONS_WITH_PROCESS_CONTROL_COMMENTS']).split
...
SHOW_REVIEW_PROCESS_CONTROL_COMMENTS = ENV['SHOW_REVIEW_PROCESS_CONTROL_COMMENTS'] == 'true'
