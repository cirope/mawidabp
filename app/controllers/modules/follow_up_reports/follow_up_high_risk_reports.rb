module FollowUpHighRiskReports
    ...
    @periods.each do |period|
      BusinessUnitType.list.each do |but|
        columns = {
          ...
          'weaknesses_by_risk' =>
            [t('follow_up_committee.weaknesses_by_risk_report_title'), 70]
        }
        column_data = []
        name = but.name
        ...
        conclusion_review_per_unit_type.each do |c_r|
          weaknesses_by_risk = []
          weaknesses = c_r.review.weaknesses.by_risk(risk).
  ...
  # de fechas
  #
  # * POST /follow_up_committee/create_weaknesses_by_risk_report
  def create_weaknesses_by_risk_report
      ...
      unless @notorious_reviews[period].blank?
        ...
        @notorious_reviews[period].each do |data|
          ...
          if !data[:external] && !@internal_title_showed
            title = t 'follow_up_committee.weaknesses_by_risk_report.internal_audit_weaknesses'
            @internal_title_showed = true
          elsif data[:external] && !@external_title_showed
            title = t 'follow_up_committee.weaknesses_by_risk_report.external_audit_weaknesses'
          ...
          unless data[:column_data].blank?
            ...
            pdf.text(
              t('follow_up_committee.weaknesses_by_risk_report.without_audits_in_the_period'))
          end
        end
      end
    end
    ...
    pdf.custom_save_as(
      t('follow_up_committee.weaknesses_by_risk_report.pdf_name',
  ...
  # fechas
  #
  # * POST /follow_up_committee/create_fixed_weaknesses_report
  ...
  def nonconformities_report
    ...
    @periods.each do |period|
      BusinessUnitType.list.each do |but|
        ...
        conclusion_review_per_unit_type.each do |c_r|
          nonconformities = []
          cr_nonconformities = c_r.review.nonconformities
            cr_nonconformities.each do |nc|
