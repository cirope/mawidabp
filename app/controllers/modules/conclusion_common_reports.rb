module ConclusionCommonReports
  def weaknesses_by_state
    ...
    @audit_types.each do |audit_type|
      @weaknesses_counts["#{audit_type}_weaknesses"] =
        Weakness.list_all_by_date(@from_date, @to_date).send(
          "#{audit_type}_audit").finals(true).count(:group => :state)
    ...
    unless params[:download].blank?
      ...
      pdf.add_title t(:'conclusion_committee_report.weaknesses_by_state.title'),
        12, :center
  ...
  def weaknesses_by_risk
      ...
      risk_levels.each do |rl|
        ...
        statuses.each do |s|
          ...
          weaknesses_count[s[1]][rl[1]] = Weakness.list_all_by_date(@from_date,
            @to_date).send("#{audit_type}_audit").finals(true).count(
    ...
    unless params[:download].blank?
      ...
      pdf.add_title t(:'conclusion_committee_report.weaknesses_by_risk.title'),
        12, :center
  ...
  def weaknesses_by_audit_type
    ...
    unless params[:download].blank?
      ...
      pdf.add_title t(:'conclusion_committee_report.weaknesses_by_audit_type.title'),
        12, :center
        ...
        unless @data[type].blank?
          @data[type].each do |data_item|
            ...
            data_item[:business_units].each do |bu, bu_data|
              ...
              pdf.add_title(
                t(:'conclusion_committee_report.weaknesses_by_audit_type.weaknesses'), 12)
              ...
              if type == :internal
                ...
                pdf.add_title(
                  t(:'conclusion_committee_report.weaknesses_by_audit_type.oportunities'), 12)
