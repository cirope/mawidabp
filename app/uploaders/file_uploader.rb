class FileUploader < CarrierWave::Uploader::Base
  ...
  private
    ...
    def organization_id_path organization_id = Current.organization_id
      ('%08d' % (organization_id || 0)).scan(/\d{4}/).join('/')
    end

    def guess_path organization_id = Current.organization_id
    ...
    def try_corporate_path
      path         = nil
      organization = Organization.find_by id: Current.organization_id
      ...
      path || path_for(Current.organization_id)
    end
end
