    ...
    module Backends
      ...
      module FileSystemBackend
        ...
        def full_filename(thumbnail = nil)
          thumb_class = (thumbnail ? thumbnail_class : self)
          file_system_path = thumb_class.attachment_options[:path_prefix].respond_to?(:call) ?
            thumb_class.attachment_options[:path_prefix].call :
