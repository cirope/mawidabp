...
#   Unknown type 'SYS.AQ$_SUBSCRIBERS' for column 'subscribers'
  ...
  create_table "closing_interview_users", force: :cascade do |t|
    t.string "kind", null: false
    t.integer "closing_interview_id", precision: 38, null: false
    t.integer "user_id", precision: 38, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["closing_interview_id"], name: "i_clo_int_use_clo_int_id"
    t.index ["user_id"], name: "i_clo_int_use_use_id"
  end
  ...
  create_table "closing_interviews", force: :cascade do |t|
    ...
    t.integer "review_id", precision: 38, null: false
    t.integer "organization_id", precision: 38, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["interview_date"], name: "i_clo_int_int_dat"
    t.index ["organization_id"], name: "i_clo_int_org_id"
    t.index ["review_id"], name: "i_closing_interviews_review_id"
  end
...
#   Unknown type 'LONG' for column 'sql_text'
  ...
  create_table "opening_interview_users", force: :cascade do |t|
    t.string "kind", null: false
    t.integer "opening_interview_id", precision: 38, null: false
    t.integer "user_id", precision: 38, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["opening_interview_id"], name: "i_ope_int_use_ope_int_id"
    t.index ["user_id"], name: "i_ope_int_use_use_id"
  end
  ...
  create_table "opening_interviews", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["interview_date"], name: "i_ope_int_int_dat"
    t.index ["organization_id"], name: "i_ope_int_org_id"
    t.index ["review_id"], name: "i_opening_interviews_review_id"
  end
  ...
  create_table "risk_assessments", force: :cascade do |t|
    ...
    t.index ["group_id"], name: "i_risk_assessments_group_id"
...
#   Unknown type 'LONG' for column 'long_value'
  ...
  add_foreign_key "closing_interview_users", "closing_interviews", on_delete: :cascade
  add_foreign_key "closing_interview_users", "users", on_delete: :cascade
  add_foreign_key "closing_interviews", "organizations", on_delete: :cascade
  add_foreign_key "closing_interviews", "reviews", on_delete: :cascade
  ...
  add_foreign_key "opening_interview_users", "opening_interviews", on_delete: :cascade
  add_foreign_key "opening_interview_users", "users", on_delete: :cascade
  add_foreign_key "opening_interviews", "organizations", on_delete: :cascade
  add_foreign_key "opening_interviews", "reviews", on_delete: :cascade
  ...
  add_foreign_key "risk_assessments", "groups", on_delete: :cascade
