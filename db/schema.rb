...
ActiveRecord::Schema[7.1].define(version: 2024_01_24_192717) do
  ...
  create_table "licenses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "paid_until", precision: nil
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.text "notes"
    t.datetime "hash_changed", precision: nil
  ...
  add_foreign_key "achievements", "benefits", name: "achievements_benefit_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  add_foreign_key "achievements", "findings", name: "achievements_finding_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  ...
  add_foreign_key "benefits", "organizations", name: "benefits_organization_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  ...
  add_foreign_key "best_practices", "groups", name: "best_practices_group_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  add_foreign_key "best_practices", "organizations", name: "best_practices_organization_id_fk", on_delete: :restrict
  add_foreign_key "business_unit_findings", "business_units", name: "business_unit_findings_business_unit_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  add_foreign_key "business_unit_findings", "findings", name: "business_unit_findings_finding_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  add_foreign_key "business_unit_kinds", "organizations", on_update: :restrict, on_delete: :restrict
  add_foreign_key "business_unit_scores", "business_units", name: "business_unit_scores_business_unit_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  add_foreign_key "business_unit_scores", "control_objective_items", name: "business_unit_scores_control_objective_item_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
  ...
  add_foreign_key "ldap_configs", "organizations", name: "ldap_configs_organization_id_fk", on_update: :restrict, on_delete: :restrict, deferrable: :deferred
