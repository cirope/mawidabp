...
ActiveRecord::Schema.define(version: 20150427051208) do
  ...
  create_table "achievements", force: true do |t|
    ...
    t.text     "comment"
    t.integer  "finding_id", precision: 38, scale: 0, null: false
  ...
  create_table "ldap_configs", force: true do |t|
    ...
    t.integer  "port",                precision: 38, scale: 0, default: 389, null: false
  ...
  add_foreign_key "achievements", "benefits", name: "achievements_benefit_id_fk"
  add_foreign_key "achievements", "findings", name: "achievements_finding_id_fk"
  ...
  add_foreign_key "ldap_configs", "organizations", name: "lda_con_org_id_fk"
