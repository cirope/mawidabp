...
ActiveRecord::Schema.define(version: 20131126161633) do
  ...
  add_index "help_contents", ["language"], name: "index_help_contents_on_language", unique: true, using: :btree
  ...
  add_index "help_items", ["help_content_id"], name: "index_help_items_on_help_content_id", using: :btree
  add_index "help_items", ["parent_id"], name: "index_help_items_on_parent_id", using: :btree
  ...
  add_index "inline_helps", ["language"], name: "index_inline_helps_on_language", using: :btree
  add_index "inline_helps", ["name"], name: "index_inline_helps_on_name", using: :btree
